...
<main id="main" class="fade">
            ...
            <table class='table table-form'>
              <tbody>
                <tr>
                  ...
                  <td><input class='form-control' type='text' name='account' id='account' value='demo' autofocus /></td>
                </tr>
                <tr>
                  <th><?php echo $lang->user->password;?></th>
                  <td><input class='form-control' type='password' name='password' value='quickon4You' /></td>
                </tr>
                <tr>
                  <th></th>
  ...
  <p style='margin-top:25px; color:#fff; text-align:center'>
    版本选择：
    <a href='https://zentao12biz.demo.haogs.cn' style='color:yellow'>企业版</a>
  </p>
